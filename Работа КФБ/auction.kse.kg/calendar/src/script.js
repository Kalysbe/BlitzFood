...
*/
var languageCode = 'ru';	// Possible values: 	ru,en,ge,no,nl,es,pt-br,fr
...
switch(languageCode){
	case "ru":	/* Russian */
		...
		var monthArrayShort = ['ßíâ','Ôåâ','Ìàð','Àïð','Ìàé','Èþí','Èþë','Àâã','Ñåí','Îêò','Íîÿ','Äåê'];
		var dayArray = ['Ïîí','Âòð','Ñðä','×òâ','Ïòí','Ñóá','Âîñ'];
		var weekString = 'Íåä';
		var todayString = '';
		break;
	case "en":	/* English */
