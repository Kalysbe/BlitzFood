...
// From templates
$_LANG["{temp_about}"] = "О Бирже";
$_LANG["{temp_general_info}"] = "Общая информация";
$_LANG["{temp_our_strategy}"] = "Cтратегия развития";
$_LANG["{temp_corporate_documents}"] = "Корпоративные документы";
$_LANG["{temp_auctioneers}"] = "Акционеры";
$_LANG["{temp_members}"] = "Участники торгов";
$_LANG["{temp_members_rating}"] = "Рейтинг участников";
$_LANG["{temp_partners}"] = "Наши партнеры";
$_LANG["{temp_management}"] = "Совет директоров";
$_LANG["{temp_revisory}"] = "Ревизионная комиссия";
$_LANG["{temp_standards}"] = "Нормативная база";
$_LANG["{temp_kse_normatives}"] = "Биржевая деятельность";
$_LANG["{temp_depo_normatives}"] = "Депозитарная деятельность";
$_LANG["{temp_open_information}"] = "Центр раскрытия информации";
$_LANG["{temp_statistics}"] = "Статистика торгов";
$_LANG["{temp_trade_results}"] = "Итоги последних торгов";
$_LANG["{temp_archive}"] = "Архив торгов";
$_LANG["{temp_index_and_capitalization}"] = "Индекс и Капитализация";
$_LANG["{temp_quotes}"] = "Котировки по ЦБ";
$_LANG["{temp_quotesgold}"] = "Котировки по драг. металлам";
$_LANG["{temp_study_center}"] = "Учебный центр";
$_LANG["{temp_education}"] = "Общая информация";
$_LANG["{temp_edu_plan}"] = "План работы на год";
$_LANG["{temp_ScheduleGS}"] = "Расписание аукционов по ГЦБ";
$_LANG["{temp_Committees}"] = "Комитеты";
$_LANG["{temp_ListingCommittee}"] = "Листинговый комитет";
$_LANG["{temp_StrategicPlanningCommittee}"] = "Комитет по стратегическому планированию и корпоративному развитию";
$_LANG["{temp_AuditCommittee}"] = "Комитет по аудиту и вознаграждениям";
...
$_LANG["indeces"]="Индексы:";
$_LANG["valueson"]="Значения на";
$_LANG["currency"]="Курс валют";
$_LANG["registration"]="Учетный курс НБКР на:";
