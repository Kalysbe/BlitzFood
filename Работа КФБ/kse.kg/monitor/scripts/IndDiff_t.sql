select '<FONT size=2  title=KSE Index>KSE</FONT>  <a href=indeks_i_kab.shtml target=_blank><img src=img/chart.gif alt=График border=0></a>' as N,
...
select '<FONT size=2  title=RTS Index>RTSI</FONT> <a href=http://www.rts.ru target=_blank><img src=img/chart.gif alt=График border=0></a>' as N,
...
select '<FONT size=2 title=Dow Jones Index>DJI</FONT> <a href=http://www.nyse.com/about/listed/lcddata.html?ticker=DJI target=_blank><img src=img/chart.gif alt=График border=0></a>' as N,
...
select '<FONT size=2  title=Sine and Pulse Index>SP500</FONT> <a href=http://www.nyse.com/about/listed/lcddata.html?ticker=SPX_I target=_blank><img src=img/chart.gif alt=График border=0></a>' as N,
