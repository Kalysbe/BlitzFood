...
$sql = array();
  ...
  echo'
      ...
      <br>
      <table bgcolor="#000000" width="100%" border="0" cellpadding="3" cellspacing="1">
        <TR>
    ...
    <table class="mytable" width="100%" border="0" cellpadding="3" cellspacing="1">
 	  <TR bgcolor="#000000">
	    <TD width="60%" style="CURSOR: HELP" align="left" title="'.$row['NAMERUS'].$row['DT'].'">
	       <font face="verdana" style="font-size:22px;font-weight:bold;" color="#8B8B00" >
	         '.$row['NAMERUS'].'
	       </font> 
	    </TD>
	    <TD width="10%"align="right"><font face="verdana" style="font-size:22px;font-weight:bold;" color="#8B8B00">'.$row['BV'].'&nbsp;</font></TD>
	    <TD width="10%"align="right"><font face="verdana" style="font-size:22px;font-weight:bold;" color="#8B8B00">'.$row['B'].'&nbsp;</font></TD>
	    <TD width="10%"align="right"><font face="verdana" style="font-size:22px;font-weight:bold;" color="#8B8B00">'.$row['SV'].'&nbsp;</font></TD>    
	    <TD width="10%"align="right"><font face="verdana" style="font-size:22px;font-weight:bold;" color="#8B8B00">'.$row['S'].'&nbsp;</font></TD>
	</TR>      
      </table>
  ';
};
