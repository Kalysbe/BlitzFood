...
$mWidth=1820;
$mHeigh=850;
$fXmlData='dyn_trade_bond_for_year.xml';
$strTitle='Динамика объема торгов по облигациям по годам';
$typeGraph='FCF_Column2D.swf';
$bodycolor='#000000';
...
<table width="100%" height=100% border=0 bgcolor="'.$bodycolor.'">
