...
$fXmlData='dyn_trade_vvp.xml';
$strTitle='Отношение капитализации листинговых компаний к ВВП за 2015 год (млн.сом)
';
#$typeGraph='FCF_MSArea2D.swf ';
$typeGraph='FCF_MSColumn2D.swf';
