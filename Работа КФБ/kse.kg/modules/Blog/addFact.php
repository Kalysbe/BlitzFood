...
if ($obj) { // При условии что id найден
    $Translit = array(
    ...
    // foreach ($input['mEntryText'] as $v) {

    //     $v = str_replace(array("\r\n", "\r", "\n"), '<br>', $v);
    //     if (is_array($input['title']['titles']['title' . $n])) {
    //         if ($input['title']['titles']['title' . $n]["type"] == 'date')
    //             $table .= '<tr><td width="40%">' . $input['title']['titles']['title' . $n]['text'] . '</td><td>' . $v . '</td></tr>';
    //         else
    //             $table .= '<tr><td colspan="2"><h5>' . $input['title']['titles']['title' . $n]['text'] . '</h5></td>';
    //     } else {
    //         $table .= '<tr><td width="40%">' . $input['title']['titles']['title' . $n] . '</td><td>' . $v . '</td></tr>';
    //     }
