	...
	<script type="text/javascript">
		...
		function drawChart()
		{
			var data = google.visualization.arrayToDataTable([
			 ["Рынок", "Значение", { role: "style" } ],
				["Первичный",{$obj->pervyi},"lightblue"],
				["Вторичный",{$obj->secondary},"orange"],
				["Листинг",{$obj->listing},"green"],
				["Нелистинг",{$obj->non_listing},"red"]
			]);
      ...
      var options = {
		...
		var chart = new google.visualization.ColumnChart(document.getElementById("Column3D"));
...
JS;
	...
	$buffer.= "<div id='Column3D'></div>".$columnChart;
    $buffer.= "</div>";
