<template>
  <div
    ...
    :style="sidebarStyle"
    @mouseleave="onSidebarWrapperBlur"
  >
    <div class="logo">
      <a :href="logo_link" class="simple-text logo-mini" target="_blank">
        <div class="logo-img">
          <img :src="logo" />
        </div>
      </a>
      <a :href="logo_link" class="simple-text logo-normal" target="_blank">
...
export default {
  ...
  methods: {
    onSidebarWrapperBlur(/*e*/) {
      this.$emit('onSidebarBlur')
    },
    minimizeSidebar() {
