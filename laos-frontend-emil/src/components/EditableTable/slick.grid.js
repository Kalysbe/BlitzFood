...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function init() {
      ...
      // ======= Patched By Nanthigna (29-Nov-2022) =======
      var headerMarginBottom = oldProps.length == 0 ? '0px' : '36px;';

      $headerL = $("<div class='slick-header-columns slick-header-columns-left' style='left:-1000px; margin-bottom:" + headerMarginBottom + ";' />").appendTo($headerScrollerL);
      $headerR = $("<div class='slick-header-columns slick-header-columns-right' style='left:-1000px; margin-bottom:" + headerMarginBottom + ";' />").appendTo($headerScrollerR);
    ...
    function setColumns(columnDefinitions) {
      ...
      if (initialized) {
        ...
        removeCssRules();
        createCssRules();
        // ======= Patched By Nanthigna (30-Nov-2022) but Why =======
        //resizeCanvas();
        updateCanvasWidth();
        applyColumnHeaderWidths();
        applyColumnWidths();
    ...
    function getViewportHeight() {
      ...
      // ======= Patched By Nanthigna (01-Dec-2022) but Why =======
      viewportH += 36;
