  ...
  <div class="md-layout">
    <div class="md-layout-item md-size-100">
      <md-card>
        <md-card-header class="md-card-header-text md-card-header-green">
          <div class="card-text">
            <h4 class="title">Satellite WebGis</h4>
          </div>
        </md-card-header>
        <md-card-content>
          <div class="card-text">
    ...
    <div class="md-layout-item md-small-size-100">
      <md-card>
        <md-card-header class="md-card-header-text md-card-header-green">
          <div class="card-text">
            <h4 class="title">Regular WebGis</h4>
          </div>
        </md-card-header>
        <md-card-content>
    ...
    <div class="md-layout-item md-small-size-100">
      <md-card>
        <md-card-header class="md-card-header-text md-card-header-green">
          <div class="card-text">
            <h4 class="title">Custom Skin & Settings WebGis</h4>
          </div>
        </md-card-header>
        <md-card-content>
...
export default {
  methods: {
    initSattelliteMap() {
      ...
      const map = new window.google.maps.WebGis(
    ...
    initRegularMap() {
      ...
      const marker = new window.google.maps.Marker({
        position: myLatlng,
        title: "Regular WebGis!"
      });

      marker.setMap(map);
    },
    initCustomSkinMap(google) {
      // Custom Skin & Settings WebGis
      ...
      const map = new google.maps.WebGis(
      ...
      const marker = new google.maps.Marker({
        position: myLatlng,
        title: "Custom Skin & Settings WebGis!"
      });
