  ...
  data() {
    return {
      ...
      menuItems: [
        ...
        {name: 'Swagger', icon: 'help', path: '/help'},
        {name: 'API', icon: 'help', path: '/apitest'},
        {name: 'Contract', icon: 'verified', path: '/contracts'},
        {name: 'Contract report', icon: 'menu', path: '/contract-report'},
        {name: 'Contracts', icon: 'verified',
        children: [
          {name: "Contract List", icon: 'fact_check', path: '/contracts'},
          {name: "Contract Report", icon: 'fact_check', path: '/contracts'}
        ]},
        {name: 'menu.map', icon: 'map', path: '/map'},
        {name: 'menu._remove_planning', icon: 'library_books', path: '/_remove_planning'},
        {name: 'menu.report', icon: 'article', path: '/reports'},
        {name: 'Reports', icon: 'plagiarism',
        children: [
          {name: "Contract Report", icon: 'article', path: '/contract-report'},
          {name: "Report", icon: 'analytics', path: '/reports'}
        ]},
