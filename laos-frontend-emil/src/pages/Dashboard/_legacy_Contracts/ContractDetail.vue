      ...
      <md-card-content>
        <md-card-header class="md-card-header-blue md-card-header-height">
          <h4 class="title" style="color:white;">{{$t('contract.title')}}
            <span class="md-layout-item md-small-size-30 md-size-30">
                <span class="c_status">{{$t("contract.contract_status")}} : </span>
                <badge :type="setContractColor(1)" class="c_badge"><u>{{setContractStatus(1)}}</u></badge>
            </span>
            <md-button class="md-raised md-success" @click="relatedData">{{$t('button.related_data')}}</md-button>
            <md-button class="md-raised md-warning" style="float: right;" @click="goback">{{$t('button.back')}}</md-button>
          
          </h4>
        </md-card-header>
        <!-- <div class="md-layout-item md-small-size-100 md-size-30">
            <h3 style="border-style: solid; border-color: coral; text-align:center;">{{$t("contract.contract_status")}}</h3>
            <badge :type="setContractColor(1)" style="font-size:16px; width:50px; height:30px;font-family: phetsarath_ot;">{{setContractStatus(1)}}</badge>
        </div> -->
...
export default {
  ...
  components: {ContractEnvironment, Badge},
  props: {
    // contract_data: {},
    tableHeaderColor: 
      {
  ...
  methods: {
    ...
    relatedData(){
      ...
      // handleEditRoadEnvironment(item){
    ...
    fundingSourceText(ids){
      ...
      if(len>1){
        ...
        // console.log("Funding Type::", fundingSource)
  ...
  async mounted() {
    ...
    // console.log("VIEW-DETAIL_CONT_LOCALES:", this.$i18n.locale)
    // console.log("CON-STATUS:", this.contract_status)
...
.c_badge {
  ...
  /* background-color:rgb(109, 167, 229);  */
  padding: 4px;
  margin-left: 30px;
}
.c_status {
  background-color:rgb(167, 197, 19); 
  margin-left: 60px; 
  border-style: solid; 
  border-color: white; 
  text-align:center;
